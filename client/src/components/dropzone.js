...
class Dropzone extends React.Component {
    ...
    getRootProps = ({
        ...
        onBlur: this.composeHandler(
            onBlur ? composeEventHandlers(onBlur, this.onBlur) : this.onBlur
        ),
        ...
        onDrop: this.composeHandler(
            onDrop ? composeEventHandlers(onDrop, this.onDrop) : this.onDrop
        ),
